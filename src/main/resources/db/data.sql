...
VALUES ('김민준', 'minjun.kim@company.com', '$2a$10$abcdefghijklmnopqrstuvwxyz123456', '1985-03-15', 'Male',
        '010-1234-5678', 2),
       ('이서연', 'seoyeon.lee@company.com', '$2a$10$abcdefghijklmnopqrstuvwxyz123456', '1987-07-22', 'Female',
        '010-2345-6789', 2),
       ('박지훈', 'jihoon.park@company.com', '$2a$10$abcdefghijklmnopqrstuvwxyz123456', '1983-11-08', 'Male',
        '010-3456-7890', 3),
       ('최유진', 'yujin.choi@company.com', '$2a$10$abcdefghijklmnopqrstuvwxyz123456', '1990-05-30', 'Female',
        '010-4567-8901', 4),
       ('정민수', 'minsu.jung@company.com', '$2a$10$abcdefghijklmnopqrstuvwxyz123456', '1982-09-12', 'Male',
        '010-5678-9012', 1),
       ('강수빈', 'subin.kang@email.com', '$2a$10$abcdefghijklmnopqrstuvwxyz123456', '1995-02-14', 'Female',
        '010-6789-0123', 1),
       ('윤재현', 'jaehyun.yoon@email.com', '$2a$10$abcdefghijklmnopqrstuvwxyz123456', '1993-08-25', 'Male',
        '010-7890-1234', 1),
       ('한예슬', 'yeseul.han@email.com', '$2a$10$abcdefghijklmnopqrstuvwxyz123456', '1996-12-03', 'Female',
        '010-8901-2345', 1),
       ('오성민', 'seongmin.oh@email.com', '$2a$10$abcdefghijklmnopqrstuvwxyz123456', '1994-04-18', 'Male',
        '010-9012-3456', 1),
       ('임지우', 'jiwoo.lim@email.com', '$2a$10$abcdefghijklmnopqrstuvwxyz123456', '1997-06-27', 'Female',
        '010-0123-4567', 1),
       ('송태양', 'taeyang.song@email.com', '$2a$10$abcdefghijklmnopqrstuvwxyz123456', '1992-10-09', 'Male',
        '010-1111-2222', 4),
       ('배소영', 'soyoung.bae@email.com', '$2a$10$abcdefghijklmnopqrstuvwxyz123456', '1995-01-21', 'Female',
        '010-2222-3333', 4),
       ('서준호', 'junho.seo@email.com', '$2a$10$abcdefghijklmnopqrstuvwxyz123456', '1991-03-17', 'Male', '010-3333-4444',
        2),
       ('나현아', 'hyuna.na@email.com', '$2a$10$abcdefghijklmnopqrstuvwxyz123456', '1998-07-05', 'Female', '010-4444-5555',
        2),
       ('황동혁', 'donghyuk.hwang@email.com', '$2a$10$abcdefghijklmnopqrstuvwxyz123456', '1993-11-29', 'Male',
        '010-5555-6666', 4);
